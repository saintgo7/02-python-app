...
**19_real_estate_listing_platform**는 Real estate property listing platform
...
#### 1단계: 저장소 클론
```bash
cd 19_real_estate_listing_platform
```
...
```bash
# 이미지 빌드
docker build -t 19_real_estate_listing_platform .

# 컨테이너 실행
docker run -p 8000:8000 19_real_estate_listing_platform
```
