...
**02_email_newsletter_platform**는 Email newsletter management and distribution platform
...
#### 1단계: 저장소 클론
```bash
cd 02_email_newsletter_platform
```
...
```bash
# 이미지 빌드
docker build -t 02_email_newsletter_platform .

# 컨테이너 실행
docker run -p 8000:8000 02_email_newsletter_platform
```
