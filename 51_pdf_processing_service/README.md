...
**51_pdf_processing_service**는 PDF processing and manipulation service
...
```bash
# 이미지 빌드
docker build -t 51_pdf_processing_service .

# 컨테이너 실행
docker run -p 8000:8000 51_pdf_processing_service
```
