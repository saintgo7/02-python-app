...
**07_api_monitoring_service**는 API uptime and performance monitoring
...
```bash
# 이미지 빌드
docker build -t 07_api_monitoring_service .

# 컨테이너 실행
docker run -p 8000:8000 07_api_monitoring_service
```
