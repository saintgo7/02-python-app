...
**20_social_network_backend**는 Social networking platform backend
...
```bash
# 이미지 빌드
docker build -t 20_social_network_backend .

# 컨테이너 실행
docker run -p 8000:8000 20_social_network_backend
```
