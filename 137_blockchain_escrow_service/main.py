...
app = FastAPI(
    title="Blockchain Escrow Service",
    version="1.0.0",
...
setup_metrics_endpoint(app, app_name="Blockchain Escrow Service", version="1.0.0", environment="production")
...
async def read_root():
    ...
    return {
        "message": "Welcome to Blockchain Escrow Service",
        "version": "1.0.0",
        "docs": {
            "swagger": "/docs",
            "redoc": "/redoc",
...
async def health_check():
    ...
    return {
        "status": "healthy",
        "version": "1.0.0",
        "service": "Blockchain Escrow Service"
    }
