...
**08_markdown_to_html_saas**는 Markdown conversion and documentation platform
...
```bash
# 이미지 빌드
docker build -t 08_markdown_to_html_saas .

# 컨테이너 실행
docker run -p 8000:8000 08_markdown_to_html_saas
```
