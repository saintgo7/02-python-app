...
**16_event_booking_system**는 Event booking and ticketing platform
...
```bash
# 이미지 빌드
docker build -t 16_event_booking_system .

# 컨테이너 실행
docker run -p 8000:8000 16_event_booking_system
```
