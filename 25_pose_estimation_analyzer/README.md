...
**25_pose_estimation_analyzer**는 Human pose estimation and analysis
...
#### 1단계: 저장소 클론
```bash
cd 25_pose_estimation_analyzer
```
...
```bash
# 이미지 빌드
docker build -t 25_pose_estimation_analyzer .

# 컨테이너 실행
docker run -p 8000:8000 25_pose_estimation_analyzer
```
