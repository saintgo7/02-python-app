...
**56_amazon_product_research_tool**는 Amazon product research and analysis
...
#### 1단계: 저장소 클론
```bash
cd 56_amazon_product_research_tool
```
...
```bash
# 이미지 빌드
docker build -t 56_amazon_product_research_tool .

# 컨테이너 실행
docker run -p 8000:8000 56_amazon_product_research_tool
```
