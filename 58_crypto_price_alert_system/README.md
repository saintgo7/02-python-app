...
**58_crypto_price_alert_system**는 Cryptocurrency price monitoring and alerts
...
#### 1단계: 저장소 클론
```bash
cd 58_crypto_price_alert_system
```
...
```bash
# 이미지 빌드
docker build -t 58_crypto_price_alert_system .

# 컨테이너 실행
docker run -p 8000:8000 58_crypto_price_alert_system
```
