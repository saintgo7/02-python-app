...
class Vehicle_DetectorModel(nn.Module):
    """PyTorch model for vehicle_detector"""
...
class ModelInference:
    """Inference wrapper for vehicle_detector"""

    def __init__(self, model_path: Union[str, Path] = None, device: str = "cpu"):
        self.device = torch.device(device)
        self.model = Vehicle_DetectorModel().to(self.device)
