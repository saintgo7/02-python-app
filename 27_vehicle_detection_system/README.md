...
**27_vehicle_detection_system**는 Vehicle detection and tracking system
...
#### 1단계: 저장소 클론
```bash
cd 27_vehicle_detection_system
```
...
```bash
# 이미지 빌드
docker build -t 27_vehicle_detection_system .

# 컨테이너 실행
docker run -p 8000:8000 27_vehicle_detection_system
```
