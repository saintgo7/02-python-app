...
**22_face_recognition_system**는 Face recognition and verification system
...
```bash
# 이미지 빌드
docker build -t 22_face_recognition_system .

# 컨테이너 실행
docker run -p 8000:8000 22_face_recognition_system
```
