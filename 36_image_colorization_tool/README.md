...
**36_image_colorization_tool**는 Automatic image colorization service
...
```bash
# 이미지 빌드
docker build -t 36_image_colorization_tool .

# 컨테이너 실행
docker run -p 8000:8000 36_image_colorization_tool
```
