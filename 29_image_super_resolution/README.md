...
**29_image_super_resolution**는 Image enhancement and super-resolution
...
```bash
# 이미지 빌드
docker build -t 29_image_super_resolution .

# 컨테이너 실행
docker run -p 8000:8000 29_image_super_resolution
```
