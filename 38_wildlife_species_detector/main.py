...
app = FastAPI(
    title="Wildlife Species Detector",
    version="1.0.0",
...
setup_metrics_endpoint(app, app_name="Wildlife Species Detector", version="1.0.0", environment="production")
...
async def read_root():
    ...
    return {
        "message": "Welcome to Wildlife Species Detector",
        "version": "1.0.0",
        "docs": {
            "swagger": "/docs",
            "redoc": "/redoc",
...
async def health_check():
    ...
    return {
        "status": "healthy",
        "version": "1.0.0",
        "service": "Wildlife Species Detector"
    }
