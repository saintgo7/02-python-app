...
class Species_DetectionModel(models.Model):
    """TensorFlow species_detection Model"""
...
class TransferLearningModel:
    """Transfer Learning wrapper for species_detection"""
...
class ModelEnsemble:
    """Ensemble multiple species_detection models"""
