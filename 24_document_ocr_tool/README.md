...
**24_document_ocr_tool**는 Optical character recognition for documents
...
```bash
# 이미지 빌드
docker build -t 24_document_ocr_tool .

# 컨테이너 실행
docker run -p 8000:8000 24_document_ocr_tool
```
