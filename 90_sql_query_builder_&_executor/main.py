...
app = FastAPI(
    title="Sql Query Builder & Executor",
    version="1.0.0",
...
setup_metrics_endpoint(app, app_name="Sql Query Builder & Executor", version="1.0.0", environment="production")
...
async def read_root():
    ...
    return {
        "message": "Welcome to Sql Query Builder & Executor",
        "version": "1.0.0",
        "docs": {
            "swagger": "/docs",
            "redoc": "/redoc",
...
async def health_check():
    ...
    return {
        "status": "healthy",
        "version": "1.0.0",
        "service": "Sql Query Builder & Executor"
    }
