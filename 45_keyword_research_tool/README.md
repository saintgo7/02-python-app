...
**45_keyword_research_tool**는 Keyword research and analysis platform
...
```bash
# 이미지 빌드
docker build -t 45_keyword_research_tool .

# 컨테이너 실행
docker run -p 8000:8000 45_keyword_research_tool
```
