...
**03_url_shortener_service**는 URL shortening service with analytics
...
```bash
# 이미지 빌드
docker build -t 03_url_shortener_service .

# 컨테이너 실행
docker run -p 8000:8000 03_url_shortener_service
```
