...
# Create FastAPI app
app = FastAPI(
    title="10_jwt_auth_service",
    version="1.0.0",
    description="10_jwt_auth_service API with Advanced Features"
)
...
def read_root():
    return {
        "message": "10_jwt_auth_service API with Advanced Features",
        "version": "1.0.0",
...
async def startup_event():
    """Startup event"""
    print("🚀 Starting 10_jwt_auth_service with advanced features...")


@app.on_event("shutdown")
async def shutdown_event():
    """Shutdown event"""
    print("🛑 Shutting down 10_jwt_auth_service...")
    if cache.client:
        cache.client.close()
