...
**10_jwt_auth_service**는 JWT-based authentication and authorization service
...
```bash
# 이미지 빌드
docker build -t 10_jwt_auth_service .

# 컨테이너 실행
docker run -p 8000:8000 10_jwt_auth_service
```
