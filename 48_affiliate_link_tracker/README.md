...
**48_affiliate_link_tracker**는 Affiliate link tracking and management
...
```bash
# 이미지 빌드
docker build -t 48_affiliate_link_tracker .

# 컨테이너 실행
docker run -p 8000:8000 48_affiliate_link_tracker
```
