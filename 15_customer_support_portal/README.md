...
**15_customer_support_portal**는 Customer support and ticketing system
...
```bash
# 이미지 빌드
docker build -t 15_customer_support_portal .

# 컨테이너 실행
docker run -p 8000:8000 15_customer_support_portal
```
