...
**06_form_builder_platform**는 No-code form builder platform
...
```bash
# 이미지 빌드
docker build -t 06_form_builder_platform .

# 컨테이너 실행
docker run -p 8000:8000 06_form_builder_platform
```
