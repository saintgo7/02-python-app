...
**09_qr_code_generator_api**는 QR code generation and management service
...
```bash
# 이미지 빌드
docker build -t 09_qr_code_generator_api .

# 컨테이너 실행
docker run -p 8000:8000 09_qr_code_generator_api
```
