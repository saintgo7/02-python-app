...
**44_social_media_scheduler**는 Social media posting scheduler
...
```bash
# 이미지 빌드
docker build -t 44_social_media_scheduler .

# 컨테이너 실행
docker run -p 8000:8000 44_social_media_scheduler
```
