...
**34_license_plate_reader**는 License plate detection and OCR
...
```bash
# 이미지 빌드
docker build -t 34_license_plate_reader .

# 컨테이너 실행
docker run -p 8000:8000 34_license_plate_reader
```
