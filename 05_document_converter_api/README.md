...
**05_document_converter_api**는 Multi-format document conversion service
...
```bash
# 이미지 빌드
docker build -t 05_document_converter_api .

# 컨테이너 실행
docker run -p 8000:8000 05_document_converter_api
```
