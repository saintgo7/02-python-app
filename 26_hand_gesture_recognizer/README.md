...
**26_hand_gesture_recognizer**는 Hand gesture recognition system
...
```bash
# 이미지 빌드
docker build -t 26_hand_gesture_recognizer .

# 컨테이너 실행
docker run -p 8000:8000 26_hand_gesture_recognizer
```
