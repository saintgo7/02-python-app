...
**57_youtube_analytics_dashboard**는 YouTube channel analytics dashboard
...
#### 1단계: 저장소 클론
```bash
cd 57_youtube_analytics_dashboard
```
...
```bash
# 이미지 빌드
docker build -t 57_youtube_analytics_dashboard .

# 컨테이너 실행
docker run -p 8000:8000 57_youtube_analytics_dashboard
```
