...
**52_data_extraction_tool**는 Data extraction from various formats
...
```bash
# 이미지 빌드
docker build -t 52_data_extraction_tool .

# 컨테이너 실행
docker run -p 8000:8000 52_data_extraction_tool
```
