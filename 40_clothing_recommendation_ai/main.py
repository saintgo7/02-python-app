...
app = FastAPI(
    title="Clothing Recommendation Ai",
    version="1.0.0",
...
setup_metrics_endpoint(app, app_name="Clothing Recommendation Ai", version="1.0.0", environment="production")
...
async def read_root():
    ...
    return {
        "message": "Welcome to Clothing Recommendation Ai",
        "version": "1.0.0",
        "docs": {
            "swagger": "/docs",
            "redoc": "/redoc",
