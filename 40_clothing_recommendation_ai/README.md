...
**40_clothing_recommendation_ai**는 Clothing recommendation system
...
#### 1단계: 저장소 클론
```bash
cd 40_clothing_recommendation_ai
```
...
```bash
# 이미지 빌드
docker build -t 40_clothing_recommendation_ai .

# 컨테이너 실행
docker run -p 8000:8000 40_clothing_recommendation_ai
```
