...
**04_expense_tracker_saas**는 Personal expense tracking and budgeting application
...
```bash
# 이미지 빌드
docker build -t 04_expense_tracker_saas .

# 컨테이너 실행
docker run -p 8000:8000 04_expense_tracker_saas
```
