...
**18_learning_management_system**는 Online learning management system
...
#### 1단계: 저장소 클론
```bash
cd 18_learning_management_system
```
...
```bash
# 이미지 빌드
docker build -t 18_learning_management_system .

# 컨테이너 실행
docker run -p 8000:8000 18_learning_management_system
```
