...
**35_product_defect_detector**는 Manufacturing defect detection system
...
```bash
# 이미지 빌드
docker build -t 35_product_defect_detector .

# 컨테이너 실행
docker run -p 8000:8000 35_product_defect_detector
```
