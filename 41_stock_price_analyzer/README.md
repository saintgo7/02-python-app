...
**41_stock_price_analyzer**는 Stock price analysis and prediction tool
...
```bash
# 이미지 빌드
docker build -t 41_stock_price_analyzer .

# 컨테이너 실행
docker run -p 8000:8000 41_stock_price_analyzer
```
