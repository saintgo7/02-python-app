...
**42_web_scraper_service**는 Automated web scraping service
...
```bash
# 이미지 빌드
docker build -t 42_web_scraper_service .

# 컨테이너 실행
docker run -p 8000:8000 42_web_scraper_service
```
