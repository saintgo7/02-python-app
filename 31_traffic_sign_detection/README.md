...
**31_traffic_sign_detection**는 Traffic sign detection and classification
...
```bash
# 이미지 빌드
docker build -t 31_traffic_sign_detection .

# 컨테이너 실행
docker run -p 8000:8000 31_traffic_sign_detection
```
