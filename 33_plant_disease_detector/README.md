...
**33_plant_disease_detector**는 Plant disease detection from images
...
```bash
# 이미지 빌드
docker build -t 33_plant_disease_detector .

# 컨테이너 실행
docker run -p 8000:8000 33_plant_disease_detector
```
