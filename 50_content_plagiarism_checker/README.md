...
**50_content_plagiarism_checker**는 Content plagiarism detection service
...
#### 1단계: 저장소 클론
```bash
cd 50_content_plagiarism_checker
```
...
```bash
# 이미지 빌드
docker build -t 50_content_plagiarism_checker .

# 컨테이너 실행
docker run -p 8000:8000 50_content_plagiarism_checker
```
