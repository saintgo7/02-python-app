...
**13_project_management_system**는 Project and team collaboration platform
...
#### 1단계: 저장소 클론
```bash
cd 13_project_management_system
```
...
```bash
# 이미지 빌드
docker build -t 13_project_management_system .

# 컨테이너 실행
docker run -p 8000:8000 13_project_management_system
```
