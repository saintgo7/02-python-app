...
**49_lead_generation_tool**는 Lead generation and qualification tool
...
```bash
# 이미지 빌드
docker build -t 49_lead_generation_tool .

# 컨테이너 실행
docker run -p 8000:8000 49_lead_generation_tool
```
