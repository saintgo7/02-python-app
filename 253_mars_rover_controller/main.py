...
setup_metrics_endpoint(app, app_name="Mars Rover Controller", version="1.0.0", environment="production")
...
async def read_root():
    ...
    return {
        "message": "Welcome to Mars Rover Controller",
        "version": "1.0.0",
        "docs": {
            "swagger": "/docs",
            "redoc": "/redoc",
