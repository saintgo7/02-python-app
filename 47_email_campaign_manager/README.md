...
**47_email_campaign_manager**는 Email marketing campaign management
...
```bash
# 이미지 빌드
docker build -t 47_email_campaign_manager .

# 컨테이너 실행
docker run -p 8000:8000 47_email_campaign_manager
```
