...
**46_competitor_price_monitor**는 E-commerce price monitoring tool
...
#### 1단계: 저장소 클론
```bash
cd 46_competitor_price_monitor
```
...
```bash
# 이미지 빌드
docker build -t 46_competitor_price_monitor .

# 컨테이너 실행
docker run -p 8000:8000 46_competitor_price_monitor
```
