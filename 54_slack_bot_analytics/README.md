...
**54_slack_bot_analytics**는 Slack bot for analytics and insights
...
```bash
# 이미지 빌드
docker build -t 54_slack_bot_analytics .

# 컨테이너 실행
docker run -p 8000:8000 54_slack_bot_analytics
```
