...
**14_inventory_management**는 Inventory tracking and management system
...
```bash
# 이미지 빌드
docker build -t 14_inventory_management .

# 컨테이너 실행
docker run -p 8000:8000 14_inventory_management
```
