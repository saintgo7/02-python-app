...
**32_medical_image_analyzer**는 Medical image analysis system
...
```bash
# 이미지 빌드
docker build -t 32_medical_image_analyzer .

# 컨테이너 실행
docker run -p 8000:8000 32_medical_image_analyzer
```
