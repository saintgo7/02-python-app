...
app = FastAPI(
    title="Swarm Robotics Controller",
    version="1.0.0",
...
setup_metrics_endpoint(app, app_name="Swarm Robotics Controller", version="1.0.0", environment="production")
...
async def read_root():
    ...
    return {
        "message": "Welcome to Swarm Robotics Controller",
        "version": "1.0.0",
        "docs": {
            "swagger": "/docs",
            "redoc": "/redoc",
...
async def health_check():
    ...
    return {
        "status": "healthy",
        "version": "1.0.0",
        "service": "Swarm Robotics Controller"
    }
