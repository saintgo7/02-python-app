...
setup_metrics_endpoint(app, app_name="Educational Content Recommender", version="1.0.0", environment="production")
...
async def read_root():
    ...
    return {
        "message": "Welcome to Educational Content Recommender",
        "version": "1.0.0",
        "docs": {
            "swagger": "/docs",
            "redoc": "/redoc",
...
async def health_check():
    ...
    return {
        "status": "healthy",
        "version": "1.0.0",
        "service": "Educational Content Recommender"
    }
