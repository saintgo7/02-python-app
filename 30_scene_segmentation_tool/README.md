...
**30_scene_segmentation_tool**는 Semantic scene segmentation
...
```bash
# 이미지 빌드
docker build -t 30_scene_segmentation_tool .

# 컨테이너 실행
docker run -p 8000:8000 30_scene_segmentation_tool
```
