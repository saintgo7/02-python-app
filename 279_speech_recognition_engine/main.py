...
setup_metrics_endpoint(app, app_name="Speech Recognition Engine", version="1.0.0", environment="production")
...
async def read_root():
    ...
    return {
        "message": "Welcome to Speech Recognition Engine",
        "version": "1.0.0",
        "docs": {
            "swagger": "/docs",
            "redoc": "/redoc",
...
async def health_check():
    ...
    return {
        "status": "healthy",
        "version": "1.0.0",
        "service": "Speech Recognition Engine"
    }
