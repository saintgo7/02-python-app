...
class Density_EstimationModel(nn.Module):
    """PyTorch model for density_estimation"""
...
class ModelInference:
    """Inference wrapper for density_estimation"""

    def __init__(self, model_path: Union[str, Path] = None, device: str = "cpu"):
        self.device = torch.device(device)
        self.model = Density_EstimationModel().to(self.device)
