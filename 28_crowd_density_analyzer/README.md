...
**28_crowd_density_analyzer**는 Crowd density estimation and analysis
...
```bash
# 이미지 빌드
docker build -t 28_crowd_density_analyzer .

# 컨테이너 실행
docker run -p 8000:8000 28_crowd_density_analyzer
```
